...
// Generated on: Jun  3 2025 21:35:00 CST (Jun  4 2025 03:35:00 UTC)
...
module counter(clk_i, rst_n_i, q_o);
  ...
  wire n_13, n_14;
  DFFX0 \q_o_reg[2] (.CN (n_13), .D (n_14), .Q (q_o[2]), .QN
       (UNCONNECTED));
  NORX0 g58__2398(.A (n_11), .B (n_10), .Y (n_14));
  DFFX0 \q_o_reg[1] (.CN (n_13), .D (n_12), .Q (q_o[1]), .QN
       (UNCONNECTED0));
  NORX0 g59__5107(.A (n_11), .B (n_8), .Y (n_12));
  NORX0 g60__6260(.A (n_7), .B (n_9), .Y (n_10));
  DFFX0 \q_o_reg[0] (.CN (n_13), .D (n_3), .Q (q_o[0]), .QN
       (UNCONNECTED1));
  ...
  INVX0 g73(.A (q_o[0]), .Y (n_2));
  INVX0 g71(.A (rst_n_i), .Y (n_11));
  INVX0 g70(.A (q_o[1]), .Y (n_1));
  INVX0 g72(.A (q_o[2]), .Y (n_0));
